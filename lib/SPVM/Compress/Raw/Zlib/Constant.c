...
int32_t SPVM__Compress__Raw__Zlib__Constant__ZLIBNG_VERNUM(SPVM_ENV* env, SPVM_VALUE* stack) {

#ifdef ZLIBNG_VERNUM
  stack[0].ival = ZLIBNG_VERNUM;
  return 0;
#else
  env->die(env, stack, "ZLIBNG_VERNUM is not defined on the system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#endif
  
}

int32_t SPVM__Compress__Raw__Zlib__Constant__ZLIBNG_VER_MAJOR(SPVM_ENV* env, SPVM_VALUE* stack) {

#ifdef ZLIBNG_VER_MAJOR
  stack[0].ival = ZLIBNG_VER_MAJOR;
  return 0;
#else
  env->die(env, stack, "ZLIBNG_VER_MAJOR is not defined on the system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#endif
  
}

int32_t SPVM__Compress__Raw__Zlib__Constant__ZLIBNG_VER_MINOR(SPVM_ENV* env, SPVM_VALUE* stack) {

#ifdef ZLIBNG_VER_MINOR
  stack[0].ival = ZLIBNG_VER_MINOR;
  return 0;
#else
  env->die(env, stack, "ZLIBNG_VER_MINOR is not defined on the system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#endif
  
}

int32_t SPVM__Compress__Raw__Zlib__Constant__ZLIBNG_VER_REVISION(SPVM_ENV* env, SPVM_VALUE* stack) {

#ifdef ZLIBNG_VER_REVISION
  stack[0].ival = ZLIBNG_VER_REVISION;
  return 0;
#else
  env->die(env, stack, "ZLIBNG_VER_REVISION is not defined on the system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#endif
  
}

int32_t SPVM__Compress__Raw__Zlib__Constant__ZLIBNG_VER_MODIFIED(SPVM_ENV* env, SPVM_VALUE* stack) {

#ifdef ZLIBNG_VER_MODIFIED
  stack[0].ival = ZLIBNG_VER_MODIFIED;
  return 0;
#else
  env->die(env, stack, "ZLIBNG_VER_MODIFIED is not defined on the system", __func__, FILE_NAME, __LINE__);
  return SPVM_NATIVE_C_BASIC_TYPE_ID_ERROR_NOT_SUPPORTED_CLASS;
#endif
