...
int32_t SPVM__Compress__Raw__Zlib__Deflate__total_out(SPVM_ENV* env, SPVM_VALUE* stack) {
...
int32_t SPVM__Compress__Raw__Zlib__Deflate__total_in(SPVM_ENV* env, SPVM_VALUE* stack) {
